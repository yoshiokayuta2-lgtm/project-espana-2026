const CACHE='espana-v4.3';
const ASSETS=['./','index.html','css/style.css?v=4.3','js/app.js?v=4.3','manifest.webmanifest','images/planning.png','images/madrid.png','images/corral.png','images/sagrada.png','images/selfie.png','images/departure.png','images/flight.png','images/couple.png'];
